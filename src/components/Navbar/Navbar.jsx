  ...
  return (
    <div>
      <section className="flex justify-between items-center py-1 px-4 xl:px-10  w-full z-10 bg-[#161722]">
        {/* Logo */}
        <div>
          <img src={logo} width={100} alt="rem-logo" />
        </div>
        {/* Navlinks */}
        <div
        ...
        >
          <ul>
            {Links.map((link) => (
              <li
                key={link.id}
                className=" md:inline my-2 px-5 py-2 text-right text-sm text-white hover:text-[#ffd2a4] border-[#ffd2a4] md:focus:border-b-2 "
              >
          ...
          <div className="flex justify-center ">
            <NavLink
              ...
              className="my-2 px-5 py-3 text-sm bg-[#ffd2a4] rounded-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300"
            >
              Contact Us
            </NavLink>
          </div>
